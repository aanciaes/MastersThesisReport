...
Finally, as always, section \ref{sec:chapter3_summary} we summarise all the findings and provide a clear transition into chapter \ref{cha:prototype_implementation}, which will present all implementation-specific details performed to achieve the described system.
