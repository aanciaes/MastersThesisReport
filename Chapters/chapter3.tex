...
Finally, as always, section \ref{sec:summary} we summarise all the findings and provide a clear transition into chapter \ref{cha:elaboration_plan}, which will present all implementation specific details performed to achieve the described system.
...
ta tudo em containers e em memoria
(NAO REFERIR TECNOLOGIAS, tipo docker e essas cenas, ainda não)
