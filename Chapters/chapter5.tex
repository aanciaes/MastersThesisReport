...
\begin{figure}[htbp]
  \centering{\includegraphics[width=1.0\linewidth]{system_cpu_load}}%
  \caption{Average CPU Load}
  \label{fig:average_cpu_load}
\end{figure}

\begin{figure}[htbp]
  \centering{\includegraphics[width=1.0\linewidth]{redis_plain_memory}}%
  \caption{Redis Plain Memory}
  \label{fig:redis_plain_memory}
\end{figure}

\begin{figure}[htbp]
  \centering{\includegraphics[width=1.0\linewidth]{redis_sgx_memory}}%41
  \caption{Redis SGX Memory}
  \label{fig:redis_sgx_memory}
\end{figure}

\begin{figure}[htbp]
  \centering{\includegraphics[width=1.0\linewidth]{redis_enc_memory}}%
  \caption{Encrypted Redis Memory}
  \label{fig:encrypted_redis_memory}
\end{figure}
...
\begin{figure}[htbp]
  \centering{\includegraphics[width=1.0\linewidth]{latency_per_data_size}}%
