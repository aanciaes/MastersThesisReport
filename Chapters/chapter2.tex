...
\begin{itemize}
	...
	\item a Graph \gls{DBMS} - \textit{"Graph databases are purpose-built to store and navigate relationships"} \cite{aws-nosql:2} 
	\item Search Engine - \textit{"nonrelational database that is dedicated to the search of data content"} \cite{aws-nosql:3} 
	\item Time Series \gls{DBMS} - \textit{"Provides optimum support for working with time-dependent data"} \cite{timeSeries:1}
\end{itemize}
