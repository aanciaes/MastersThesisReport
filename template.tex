...
%force-texpad-dependency: Chapters/abstract-pt.tex
%force-texpad-dependency: Chapters/abstract-en.tex
%force-texpad-dependency: Chapters/dedicatory.tex
%force-texpad-dependency: Chapters/acknowledgements.tex
%force-texpad-dependency: Chapters/quote.tex
%force-texpad-dependency: Chapters/glossary.tex
%force-texpad-dependency: Chapters/acronyms.tex
%force-texpad-dependency: Chapters/chapter1.tex
%force-texpad-dependency: Chapters/chapter2.tex
%force-texpad-dependency: Chapters/chapter3.tex
%force-texpad-dependency: Chapters/chapter4.tex
%force-texpad-dependency: Chapters/chapter5.tex
%force-texpad-dependency: Chapters/chapter6.tex
%force-texpad-dependency: Chapters/appendix1.tex
%force-texpad-dependency: Chapters/appendix2.tex
%force-texpad-dependency: Chapters/annex1.tex
%force-texpad-dependency: Chapters/annex2.tex
%force-texpad-dependency: Chapters/annex3.tex
%force-texpad-dependency: bibliography.bib
...
\title[A Trusted and Privacy-Enhanced In-Memory Data Store]{A Trusted and Privacy-Enhanced In-Memory Data Store}

% Autor
% use [f] for female and [m] for male
\authorname[m]{Miguel de Lemos Dias Rosa Anciães}{Miguel Anciães}
...
% use [f] for female and [m] for male
\adviser[m]{Dr. Henrique João Lopes Domingos}{\\&DI-FCT-UNL}{NOVA LINCS}
...
\committee[c,m]{Dr. João Carlos Gomes Moura Pires}
% Main raporteurs
\committee[r,m]{Dr. Pedro Morais Ricardo Inácio}
% Advisers
\committee[a,m]{Dr. Henrique João Lopes Domingos}
% Other members of the committee - include the Adviser in this list
\committee[m,m]{Dr. Henrique João Lopes Domingos}
